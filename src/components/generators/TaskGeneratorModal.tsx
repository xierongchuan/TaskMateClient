...
import type { ApiErrorResponse, ResponseType } from '../../types/task';
...
const RESPONSE_TYPE_OPTIONS = Object.entries(RESPONSE_TYPE_LABELS).map(([value, label]) => ({
  value,
  label,
}));
...
export const TaskGeneratorModal: React.FC<TaskGeneratorModalProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    response_type: RESPONSE_TYPES.NOTIFICATION as ResponseType,
